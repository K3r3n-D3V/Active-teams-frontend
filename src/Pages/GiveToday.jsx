...
//   const paperShadow = { borderRadius: 2, p: 3, boxShadow: '0 4px 12px rgba(0,0,0,0.08)' };
...
//           <Paper variant="outlined" sx={paperShadow}>
...
//               Full Name
//             </Typography>
//             <TextField fullWidth size="small" placeholder="John Doe" defaultValue="John Doe" sx={{ mb: 2 }} />

//             <Typography fontWeight={600} fontSize={13} mb={0.5}>
//               Email Address
//             </Typography>
//             <TextField fullWidth size="small" placeholder="john@example.com" defaultValue="john@example.com" sx={{ mb: 2 }} />

//             <Typography fontWeight={600} fontSize={13} mb={0.5}>
//               Home Address
//             </Typography>
//             <TextField fullWidth multiline rows={3} placeholder="123 Main St, City, Country" defaultValue="123 Main St, City, Country" size="small" />
//           </Paper>
//         </Grid>
...
//             <Box sx={{ display: 'flex', justifyContent: 'space-between', fontSize: 14, mb: 1 }}>
...
//             <Box sx={{ display: 'flex', justifyContent: 'space-between', fontWeight: 700, fontSize: 16, mb: 2 }}>
//               <Typography>Total:</Typography>
//               <Typography>R0.00</Typography>
//             </Box>

//             <Box sx={{ display: 'flex', alignItems: 'center', color: 'text.secondary', fontSize: 12, mb: 1 }}>
//               <LockIcon fontSize="small" sx={{ mr: 0.5 }} />
//               Secure payment via Yoco
//             </Box>

//             <Button variant="contained" fullWidth sx={{ backgroundColor: '#000', '&:hover': { backgroundColor: '#222' }, fontWeight: 600, fontSize: 14, mb: 1 }}>
//               Complete Payment
//             </Button>
...
//               <FormControlLabel value="auto" control={<Radio />} label="Auto-generate receipt (sent to email)" />
//               <FormControlLabel value="custom" control={<Radio />} label="Upload custom receipt" />
//             </RadioGroup>
//           </FormControl>
//         </Paper>
//       </Box>
