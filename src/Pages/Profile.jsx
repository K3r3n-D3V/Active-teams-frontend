              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField
                    ...
                    onChange={handleChange("leader@1")}
                    fullWidth
                    disabled={true}
                    sx={commonFieldSx}
                  />
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField
                    ...
                    onChange={handleChange("leader@12")}
                    fullWidth
                    disabled={true}
                    sx={commonFieldSx}
                  />
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField
                    ...
                    onChange={handleChange("leader@144")}
                    fullWidth
                    disabled={true}
                    sx={commonFieldSx}
                  />
                  ...
                  <Grid item xs={12}>
                    ...
                    <TextField
                      ...
                      InputProps={{
                        inputProps: {
                          style: {
                            WebkitTextSecurity: showPassword.current
                              ? "none"
                              : "disc",
                          },
                        },
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <TextField
                      ...
                      InputProps={{
                        inputProps: {
                          style: {
                            WebkitTextSecurity: showPassword.new
                              ? "none"
                              : "disc",
                          },
                        },
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <TextField
                      ...
                      InputProps={{
                        inputProps: {
                          style: {
                            WebkitTextSecurity: showPassword.confirm
                              ? "none"
                              : "disc",
                          },
                        },
